...
TrainLM=lm(HousePriceOfUnitArea ~ TransactionDate + HouseAge + DistanceToMRT + NumberOfConStores + Latitude + Longitude + HousePriceDueToMRT, data=Train)
...
#The Cook's Distance plot shows that 271 has a pretty high value of about 0.26 but it is not more than 0.5 so it is not influential, but points 20 and 276 are. So we are going to remove 20 and 276.
```


##Getting rid of the outliers
```{r}
Train=filter(Train,!(No %in% c("20","276") ))
